...
const CACHE_VERSION='app-shell-4';
const PREFIX='kovea-shell:';
const CACHE=PREFIX+CACHE_VERSION;
const ASSETS=['./','./index.html','./crypto-utils.js','./app.js','./db.js','./schema.js','./reports.js','./diagnostics.js','./progression.js','./styles.css','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
